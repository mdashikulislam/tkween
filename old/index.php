            ...
            <div id="introCarousel" class="carousel  slide carousel-fade" data-ride="carousel">
                ...
                <div class="carousel-inner" role="listbox">
                    <div class="carousel-item active"
                        style="background-image: url(assets/img/eidhero.jpg); background-position: bottom;">
                <!--
                        ...
                        <!--
                    <div class="carousel-item" style="background-image: url(assets/img/ramadan2.jpg)">
...
<!--
                    <div class="carousel-item" style="background-image: url(assets/img/intro-carousel/bookad1.jpg)">
                        <div class="slide2 carousel-container">
                            <div class="container-fluid" style="padding:0">
                    ...
                    <div class="col-lg-12">
                        <div class="banner_slider owl-carousel">
                            <div class="single_slid_item">
                                <a href="#plan">
                                    <img src="assets/img/ban1ner01.png">
                                </a>
                            </div>
                            <!--
                            <div class="single_slid_item">
                                <img src="assets/img/bannerl.jpeg">
                            </div>
                            -->
                        </div>
                    </div>
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-12">
                        ...
                        <div class="single_table">
                            <ul class="nav nav-tabs tabls_1" style="width:600px">
                                <li><a data-toggle="tab" href="#eBook">الكتب الإلكترونية</a>
                                </li>
                                <li><a data-toggle="tab" href="#sBook">الكتب الملونة</a>
                                </li>
                                <li class="active"><a data-toggle="tab" href="#pBook" class="active">الكتب العادية</a>
                                </li>
                                
                            </ul>
                            <div class="tab-content">
                           		<div id="eBook" class="tab-pane fade" style="direction: rtl;">
                                            ...
                                            <div id="black_2" class="tab-pane fade in active show">
                                                <div class="row justify-content-center">
                                                    ...
                                                    <div class="col-lg-3 col-md-4 col-sm-6">
                                                        <div class="single_price_item">
                                                            <h3>9</h3>
                                                            <h2><span>دولار</span>225</h2>
                                                            <ul>
                                                                <li>50% <span>نسبة المؤلف</span></li>
                                                                <li  style="padding-top: 20px;">
                                                                    <form method="POST" action="contract-form.php">
                                                                        <input type="hidden" name="plan" value="دولار 225">
                                                                        <input type="hidden" name="plan_percent" value="50%">
                                                                        <input type="hidden" name="plan_type_1" value="أسود / ملون">
                                                                        <input type="hidden" name="plan_type_2" value="أدبي/علمي">
                                                                        <input type="hidden" name="heading" value="15X21 B5">
                                                    ...
                                                    <div class="col-lg-3 col-md-4 col-sm-6">
                                                        <div class="single_price_item">
                                                            <h3>10</h3>
                                                            <h2><span>دولار</span>150</h2>
                                                            <ul>
                                                                <li>25% <span>نسبة المؤلف</span></li>
                                                                <li  style="padding-top: 20px;">
                                                                    <form method="POST" action="contract-form.php">
                                                                          <input type="hidden" name="plan" value="دولار 150">
                                                                        <input type="hidden" name="plan_percent" value="25%">
                                                                        <input type="hidden" name="plan_type_1" value="أسود / ملون">
                                                                        <input type="hidden" name="plan_type_2" value="أدبي/علمي">
                                                                         <input type="hidden" name="heading" value="15X21 B5">
                                                                          <input type="hidden" name="type" value="1">
                                                    ...
                                                    <div class="col-lg-3 col-md-4 col-sm-6">
                                                        <div class="single_price_item">
                                                            <h3>7</h3>
                                                            <h2><span>ريال</span>5900</h2>
                                                            <ul>
                                                                <li>40% <span>نسبة المؤلف</span></li>
                                                                <li>
                                                                    <form method="POST" action="contract-form.php">
                                                                        <input type="text" name="plan" value="ريال 5900">
                                                                        <input type="text" name="plan_percent" value="40%">
                                                                        <input type="text" name="plan_type_1" value="أسود / ملون">
                                                                        <input type="text" name="plan_type_2" value="أدبي/علمي">
                                                                         <input type="hidden" name="heading" value="15X21 B5">
                                                                          <input type="hidden" name="type" value="1">
                                                                        <button type="submit">إشترك</button>
                                                                    </form>
                                                    ...
                                                    <div class="col-lg-3 col-md-4 col-sm-6">
                                                        <div class="single_price_item">
                                                            <h3>8</h3>
                                                            <h2><span>ريال</span>6900</h2>
                                                            <ul>
                                                                <li>50% <span>نسبة المؤلف</span></li>
                                                                <li>
                                                                    <form method="POST" action="contract-form.php">
                                                                        <input type="text" name="plan" value="ريال 6900">
                                                                        <input type="text" name="plan_percent" value="50%">
                                                                        <input type="text" name="plan_type_1" value="أسود / ملون">
                                                                        <input type="text" name="plan_type_2" value="أدبي/علمي">
                                                                         <input type="hidden" name="heading" value="15X21 B5">
                                                                          <input type="hidden" name="type" value="1">
                                ...
                                <div id="pBook" class="tab-pane fade in active show" style="direction: rtl;">
                                   
                                   <center>
                                   <p style="direction: ltr;">
                                    <b style="color:#700308">
                                        21X15 A5 مقاس الكتاب
                                    </b>
                                   </p>
                                   </center>
                                                ...
                                                <div class="row justify-content-center">
                                                    ...
                                                    <div class="col-lg-3 col-md-4 col-sm-6">
                                                        <div class="single_price_item">
                                                            ...
                                                            <h3>1</h3>
                                                            <h2><span>ريال</span>2900</h2>
                                                            <ul>
                                                                <li>10% <span>نسبة المؤلف</span></li>
                                                               <li  style="padding-top: 20px;">
                                                                    <form method="POST" action="contract-form.php">
                                                                         <input type="hidden" name="plan" value="ريال 2900">
                                                                        <input type="hidden" name="plan_percent" value="10%">
                                                                        <input type="hidden" name="plan_type_1" value="أسود وأبيض">
                                                                        <input type="hidden" name="plan_type_2" value="أدبي">
                                                                        <input type="hidden" name="heading" value="21X15 A5">
                                                    ...
                                                    <div class="col-lg-3 col-md-4 col-sm-6">
                                                        <div class="single_price_item">
                                                            <h3>2</h3>
                                                            <h2><span>ريال</span>3900</h2>
                                                            <ul>
                                                                <li>20% <span>نسبة المؤلف</span></li>
                                                                <li  style="padding-top: 20px;">
                                                                    <form method="POST" action="contract-form.php">
                                                                       <input type="hidden" name="plan" value="ريال 3900">
                                                                        <input type="hidden" name="plan_percent" value="20%">
                                                                        <input type="hidden" name="plan_type_1" value="أسود وأبيض">
                                                                        <input type="hidden" name="plan_type_2" value="أدبي">
                                                                          <input type="hidden" name="heading" value="21X15 A5">
                                                                          <input type="hidden" name="type" value="0">
                                                    ...
                                                    <div class="col-lg-3 col-md-4 col-sm-6">
                                                        <div class="single_price_item">
                                                            <h3>3</h3>
                                                            <h2><span>ريال</span>4900</h2>
                                                            <ul>
                                                                <li>40% <span>نسبة المؤلف</span></li>
                                                               <li  style="padding-top: 20px;">
                                                                    <form method="POST" action="contract-form.php">
                                                                         <input type="hidden" name="plan" value="ريال 4900">
                                                                        <input type="hidden" name="plan_percent" value="40%">
                                                                        <input type="hidden" name="plan_type_1" value="أسود وأبيض">
                                                                        <input type="hidden" name="plan_type_2" value="أدبي">
                                                                          <input type="hidden" name="heading" value="21X15 A5">
                                                                          <input type="hidden" name="type" value="0">
                                                    ...
                                                    <div class="col-lg-3 col-md-4 col-sm-6">
                                                        <div class="single_price_item">
                                                            ...
                                                            <ul>
                                                                ...
                                                                <li  style="padding-top: 20px;">
                                                                    <form method="POST" action="contract-form.php">
                                                                       <input type="hidden" name="plan" value="ريال 5900">
                                                                        <input type="hidden" name="plan_percent" value="50%">
                                                                        <input type="hidden" name="plan_type_1" value="أسود وأبيض">
                                                                        <input type="hidden" name="plan_type_2" value="أدبي">
                                                                          <input type="hidden" name="heading" value="21X15 A5">
                                                    ...
                                                    <div class="col-lg-3 col-md-4 col-sm-6" style="margin-top:20px">
                                                        <div class="single_price_item" style="background-color:gold">
                                                            <h5>عرض العيد</h5>
                                                            <h2><span>ريال</span>1442</h2>
                                                            <ul>
                                                                <li>20% <span>نسبة المؤلف</span></li>
                                                                <li  style="padding-top: 20px;">
                                                                    <form method="POST" action="contract-form.php">
                                                                       <input type="hidden" name="plan" value="ريال 1442">
                                                                        <input type="hidden" name="plan_percent" value="20%">
                                                                        <input type="hidden" name="plan_type_1" value="أسود">
                                                                        <input type="hidden" name="plan_type_2" value="أدبي/علمي">
                                                                         <input type="hidden" name="heading" value="21X15 A5">
                                                                         <input type="hidden" name="type" value="0">
                                                                        <button type="submit">إشترك</button>
                                                    ...
                                                    <!--
                                                    <div class="col-lg-3 col-md-4 col-sm-6" style="margin-top:20px">
                                                        <div class="single_price_item" style="background-color:#42248a">
                                                            <h5>بمناسبة شهر رمضان الكريم</h5>
                                                            <h2><span>ريال</span>4000</h2>
                                                            <ul>
                                                                <li>50% <span>نسبة المؤلف</span></li>
                                                                <li  style="padding-top: 20px;">
                                                                    <form method="POST" action="contract-form.php">
                                                                       <input type="hidden" name="plan" value="ريال 4000">
                                                                        <input type="hidden" name="plan_percent" value="50%">
                                                                        <input type="hidden" name="plan_type_1" value="أسود">
                                                                        <input type="hidden" name="plan_type_2" value="أدبي/علمي">
                                                                         <input type="hidden" name="heading" value="15X21 B5">
                                ...
                                <div id="sBook" class="tab-pane fade" style="direction: rtl;">
                                    
                                    
									<center>
                                   <p style="direction: ltr;">
                                    <b style="color:#700308;">
                                        24X16 B5 مقاس الكتاب
                                    </b>
                                   </p>
                                   </center>	                                    
                                    <div class="single_table_inner">
                                                            ...
                                                            <ul>
                                                               ...
                                                               <li  style="padding-top: 20px;">
                                                                    <form method="POST" action="contract-form.php">
                                                                        <input type="hidden" name="plan" value="ريال 3900">
                                                                        <input type="hidden" name="plan_percent" value="10%">
                                                                        <input type="hidden" name="plan_type_1" value="ملون">
                                                                        <input type="hidden" name="plan_type_2" value="أدبي/علمي">
                                                                          <input type="hidden" name="heading" value="24X16 B5">
                                                    ...
                                                    <div class="col-lg-3 col-md-4 col-sm-6">
                                                        <div class="single_price_item">
                                                            ...
                                                            <ul>
                                                                ...
                                                                <li  style="padding-top: 20px;">
                                                                    <form method="POST" action="contract-form.php">
                                                                         <input type="hidden" name="plan" value="ريال 6900">
                                                                        <input type="hidden" name="plan_percent" value="50%">
                                                                        <input type="hidden" name="plan_type_1" value="ملون">
                                                                        <input type="hidden" name="plan_type_2" value="أدبي/علمي">
                                                                         <input type="hidden" name="heading" value="24X16 B5">
        ...
        <section id="contact" class="section-bg" style="background-color: #ffffff;">
            <div class="container" data-aos="fade-up">
                ...
                <div class="form" style="direction: rtl;">
                    <form action="admin/site/send_msg" method="post" style="  background-color: #f7f7f7;padding: 20px;
">
                        <div class="form-row">
                    ...
                    <div class="col-lg-4 col-md-6 footer-links" style="text-align: right; margin-top: 50px;">
                        ...
                        <ul>
                            ...
                            <li><a href="#services">خدماتنا</a><i class="ion-ios-arrow-left"
                                    style="margin-left: 10px;"></i>
                            <li><a href="authorguide.php">دليل المؤلف</a><i class="ion-ios-arrow-left" style="margin-left: 10px;"></i>
                            </li>
                        </ul>
                    </div>
