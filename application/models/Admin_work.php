...
class admin_work extends CI_Model 
{
	...
	public function peg3($table_name,$data, $year ,$limit , $offset)
	{
		$q = $this->db->where($data)->like('dt', $year)->limit($limit, $offset)->order_by('id','desc')->get($table_name)->result_array();
		 return $q;		
	}
