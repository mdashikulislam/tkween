                ...
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        <div class="card m-b-30">
                            ...
                            <form method="get" action="<?= $this->load->config->base_url() ?>user/pending-publishing">
                                    ...
                                    <table  class="table table-bordered">
                                        ...
                                        <td><?= $rr['cid'] ?></td>
                                         <td>
                                            ...
                                            <td>
                                            <a  href="<?= $this->load->config->base_url() ?>user/contract_detail/awaiting_books/<?=  $rr['id'] ?>">Detail</a>
                                            </td>
