                ...
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        <div class="card m-b-30">
                            ...
                            <form method="get" action="<?= $this->load->config->base_url() ?>user/correction">
                                    ...
                                    <table class="table table-bordered">
                                        ...
                                        <td><?= $rr['cid'] ?></td>
                                         <td>
                                            ...
                                            <td>
											<?php
                                            $date=date_create($rr['correction_dt']);
                                            echo date_format($date,"d/m/Y");
                                            ?>
                                            </td>
                                            <td>
                                            <a  href="<?= $this->load->config->base_url() ?>user/contract_detail/correction/<?=  $rr['id'] ?>">Detail</a>
                                            </td>
