                ...
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        <div class="card m-b-30">
                            ...
                            <form method="get" action="<?= $this->load->config->base_url() ?>user/contracts/<?= $this->uri->segment(3) ?>">
                            ...
                            <h5 class="card-title">
                                ...
                                Pending
                                <?php elseif($this->uri->segment(3)=='inprogress'):?>
                                Inprogress
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    ...
                                    <table class="table table-bordered table-hover">
                                        ...
                                        <tr>
                                        <td>
										<a  href="<?= $this->load->config->base_url() ?>user/contract_detail/processing/<?=  $rr['id'] ?>">
										<?= $rr['cid'] ?>
                                        </a>
                                        </td>
