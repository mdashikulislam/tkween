                    ...
                    <div class="col-lg-12">
                        <div class="card m-b-30">
                            ...
                            aria-label="Search" aria-describedby="button-addonSearch">  
                             ...
                             <input type="hidden" value="sales_order" name="url" />
                                <br />
                                <?php else: ?>
                                <input type="hidden" value="sales_order?book_id=<?= $this->input->get('book_id') ?>" name="url" />
...
<?php endif ?>
                                            ...
                                            <td>
                                             ...
                                             <?php if($this->input->get('book_id')): ?>
                                            <a  class="btn btn-danger-rgba"  onclick="return confirm('want to delete')" href="<?= $this->load->config->base_url() ?>dashboard/delete_sale_order/<?= $rr['id'] ?>?url=sales_order?book_id=<?= $this->input->get('book_id')  ?>">Delete</a>
                                           <?php else: ?>
                                            <a   class="btn btn-danger-rgba"  onclick="return confirm('want to delete')" href="<?= $this->load->config->base_url() ?>dashboard/delete_sale_order/<?= $rr['id'] ?>?url=sales_order">Delete</a>
                                           <?php  endif?>
