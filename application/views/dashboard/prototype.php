                ...
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        <div class="card m-b-30">
                            ...
                            <form method="get" action="<?= $this->load->config->base_url() ?>dashboard/prototype">
 ...
 <table class="table table-bordered">
                                        ...
                                        <td>
										 <?= $rr['cid'] ?>
                                            ...
                                            <td>
                                            <?php $date=date_create($rr['final_book_dt']);echo date_format($date,"d/m/Y"); ?>
...
$correction2 = $this->db->where(array('pid'=>$rr['id'],'type'=>4))->order_by('id','desc')->get('correction_log')->result_array();
if(count($correction2))
{
...
?>
                                           ...
                                           <td>
                                            ...
                                            <td>
                                            <a class="btn btn-secondary-rgba"   href="<?= $this->load->config->base_url() ?>dashboard/contract_detail/printing_prototype/<?=  $rr['id'] ?>">Detail</a>
                                            </td>
