                ...
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        <div class="card m-b-30">
                            ...
                            <form method="get" action="<?= $this->load->config->base_url() ?>dashboard/bookcover">
                                ...
                                <table class="table table-bordered">
                                        ...
                                        <td>
										 <?= $rr['cid'] ?>
                                            ...
                                            <td>
                                            <?php $date=date_create($rr['inner_design_dt']);echo date_format($date,"d/m/Y"); ?>
...
$correction2 = $this->db->where(array('pid'=>$rr['id'],'type'=>1))->order_by('id','desc')->get('correction_log')->result_array();
if(count($correction1) && count($correction2)==0)
{
...
elseif(count($correction2))
{
	$date=date_create($correction2[0]['dt']);
	echo date_format($date,"d/m/Y");
	$up_dt = $correction2[0]['up_dt'];
}
else
{
echo '---';
...
?>
                                           ...
                                           <td>
                                            ...
                                            <td>
                                            <a class="btn btn-secondary-rgba"   href="<?= $this->load->config->base_url() ?>dashboard/contract_detail/cover_design/<?=  $rr['id'] ?>">Detail</a>
                                            </td>
