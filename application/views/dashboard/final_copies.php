                ...
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        <div class="card m-b-30">
                            ...
                            <form method="get" action="<?= $this->load->config->base_url() ?>dashboard/final_copies">
...
$correction2 = $this->db->where(array('pid'=>$rr['id'],'type'=>3))->order_by('id','desc')->get('correction_log')->result_array();
...
?>
                                           ...
                                           <td>
                                            ...
                                            <td>
                                            <a class="btn btn-secondary-rgba"   href="<?= $this->load->config->base_url() ?>dashboard/contract_detail/final_book/<?=  $rr['id'] ?>">Detail</a>
                                            </td>
