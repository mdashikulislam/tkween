                    ...
                    <div class="col-lg-5">
                        <div class="card m-b-30">
                            ...
                            <div class="card-body py-5">
                                ...
                                <form enctype="multipart/form-data" method="post" action="<?= $this->load->config->base_url() ?>dashboard/update_profile_data">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="exampleInputEmail1" value="<?=$rec[0]['email'] ?>" name="email"  aria-describedby="emailHelp" >
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="exampleInputEmail1" value="<?=$rec[0]['pass'] ?>" name="pass"  aria-describedby="emailHelp">
                                    </div>
                                    <div class="form-group">
